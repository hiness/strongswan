	...
	key_data_t *data, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, private_key_t**, out);
	...
	shared_data_t *data, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, shared_key_t**, out, id_match_t*, me, id_match_t*, other);
