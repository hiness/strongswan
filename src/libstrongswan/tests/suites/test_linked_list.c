...
{
	VA_ARGS_VGET(args, void*, a, void*, b);
	ck_assert(a == (void*)1);
	ck_assert(b == (void*)2);
...
CALLBACK(find_args, bool,
	void *item, va_list args)
{
	VA_ARGS_VGET(args, int*, a, int, b, level_t, c, uint64_t, d, uint64_t, e);
...
{
	VA_ARGS_VGET(args, void*, a, void*, b, void*, c, void*, d, int*, sum);
