	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, encryption_algorithm_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, integrity_algorithm_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, hash_algorithm_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, pseudo_random_function_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, ext_out_function_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, diffie_hellman_group_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, rng_quality_t*, algo, const char**, plugin_name);
	...
	void *n, enumerator_t *orig, va_list args)
{
	...
	VA_ARGS_VGET(args, const char**, plugin_name);
