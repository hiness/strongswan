...
{
	VA_ARGS_VGET(args, identification_t*, id, identification_t*, peer_id);
...
{
	VA_ARGS_VGET(args, chunk_t, connect_id);
...
{
	VA_ARGS_VGET(args, host_t*, local, host_t*, remote);
